...
const LoginForm: React.FC = () => {
  ...
  const [email, setEmail] = useState('savienglish@gmail.com');
  const [password, setPassword] = useState('savi123');
    ...
    try {
      ...
      if (error) {
        ...
        if (error.message?.includes('Email not confirmed')) {
          setError('Email not confirmed. Please check your email for a verification link or contact an administrator.');
        } else {
